...
(function () {
  ...
  const translations = {
    ...
    ar: {
      ...
      'contact-h2':         'نستثمر حيث يلتقي التوافق الاستراتيجي، والإمكانات الممتدة، و<em>الأثر المستدام</em>.',
  ...
  const metaSEO = {
    ...
    ar: {
      title:       'ماينورِتي بارتنرز — رأس مال استراتيجي. أثرٌ مستدام.',
      ...
      ogTitle:     'ماينورِتي بارتنرز — رأس مال استراتيجي. أثرٌ مستدام.',
      ...
      ogImageAlt:  'ماينورِتي بارتنرز — رأس مال استراتيجي. أثرٌ مستدام.',
    },
  };
